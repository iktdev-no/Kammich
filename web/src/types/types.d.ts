...
export type UploadJobStatus = "Queued" | "Running" | "Stopped" | "Completed" | "Failed" | "Cancelled"
...
export interface TailscaleNetcheck {
  captivePortal: string | null;
  globalV4: string | null;
  globalV6: string | null;
  icmpv4: boolean;
  ipv4: boolean;
  ipv4CanSend: boolean;
  ipv6: boolean;
  ...
  pcp: boolean;
  pmp: boolean;
  preferredDerp: number | null;
  regionLatency: Record<number, string>;
  regionV4Latency: Record<number, string>;
  regionV6Latency: Record<number, string>;
  udp: boolean;
  upnp: boolean;
}
...
export interface TailscaleDns {
  ...
  splitDnsRoutes: Record<string, TailscaleDnsServer[]>;
...
export interface CaptivePortalMonitorStatus {
  alive: boolean;
...
export type Verification = "Verified" | "Verifying" | "NotVerified" | "Failed"

export interface NetworkInterfaceScannerStatus {
  alive: boolean;
...
export type EthernetInterfaceClientError = "Unknown"
